...
const DIFF_MODS = {
    ...
    nightmare: { hpBonus: -2, enemyHpMult: 2.0, enemySpdMult: 1.3, enemyDmgMult: 1.6, label: '💀 Pesadelo', rewardMult: 0.12 }
};
