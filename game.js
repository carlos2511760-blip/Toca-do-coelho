...
class Player extends Actor {
    ...
    useAbility() {
        ...
        else if (this.charType === 6 && this.toxicCD <= 0) { enemies.forEach(e => { if (dist(this.x, this.y, e.x, e.y) < 150) { e.takeDamage(10 * this.dmgMult); e.slowTimer = 3; } }); this.toxicCD = 8; boom(this.x, this.y, '#2ecc71', 40); }
        else if (this.charType === 7 && this.empCD <= 0) { enemies.forEach(e => { if (dist(this.x, this.y, e.x, e.y) < 250) { e.stunTimer = 3; e.takeDamage(5 * this.dmgMult); } }); this.empCD = 12; boom(this.x, this.y, '#f1c40f', 50); }
