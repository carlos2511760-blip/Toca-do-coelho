...
const I18N = {
    ...
    translations: {
        ...
        pt: {
            ...
            leaderboard_hint: 'Os maiores heróis que já desafiaram a Toca.',
            ...
            // — Personagens —
            char_0_name: 'Coelho Estrelar', char_0_passive: 'Tiro: Rastro que afasta inimigos', char_0_active: 'Ativa (Q): Chuva de Estrelas Mágicas',
            char_1_name: 'Coelho Simbionte', char_1_passive: 'Tiro: Dano aumentado', char_1_active: 'Ativa (Q): Sobrecarga (3x Dano e Invuln.)',
            char_2_name: 'Coelho Térmico', char_2_passive: 'Tiro: Rajada rápida de fogo', char_2_active: 'Ativa (Q): Laser de Plasma Perfurante',
            char_3_name: 'Coelho Cronos', char_3_passive: 'Tiro: Lentidão nos inimigos', char_3_active: 'Ativa (Q): Rejuvenecer (Cura 2 HP)',
            char_4_name: 'Coelho Espiritual', char_4_passive: 'Tiro: Ricochete (3x)', char_4_active: 'Ativa (Q): Invocação de Espíritos Guardiães',
            char_5_name: 'Coelho Alquimista', char_5_passive: 'Tiro: Lentidão nos inimigos', char_5_active: 'Ativa (Q): Chuva de Gelo Abissal',
            char_6_name: 'Coelho Druida', char_6_passive: 'Tiro: Veneno persistente', char_6_active: 'Ativa (Q): Natureza Tóxica (Dano e Veneno em área)',
            char_7_name: 'Coelho Astronauta', char_7_passive: 'Tiro: Elétrico (Paralisia)', char_7_active: 'Ativa (Q): Pulso EMP (Stun em área)',
            char_8_name: 'Coelho Pirata', char_8_passive: 'Tiro: Fogo', char_8_active: 'Ativa (Q): Barragem de Incêndio (5 Tiros)',
            char_9_name: 'Coelho Viking', char_9_passive: 'Tiro: Fogo', char_9_active: 'Ativa (Q): Trevo da Sorte (Ganha Ouro)',
            char_10_name: 'Coelho Ninja', char_10_passive: 'Passiva: Chance de Esquiva', char_10_active: 'Ativa (Q): Clone Sombrio e Teleporte',
            char_11_name: 'Coelho Alquimista II', char_11_passive: 'Passiva: Cura aumentada', char_11_active: 'Ativa (Q): Explosão Química',
            char_12_name: 'Coelho Druida II', char_12_passive: 'Passiva: Cura ao mudar de sala', char_12_active: 'Ativa (Q): Raízes Paralisantes',
            char_13_name: 'Coelho Astronauta II', char_13_passive: 'Passiva: Pulo prolongado', char_13_active: 'Ativa (Q): Jato de Propulsão',
            char_14_name: 'Coelho Pirata II', char_14_passive: 'Passiva: Ouro bônus', char_14_active: 'Ativa (Q): Chuva de Canhão',
            char_15_name: 'Coelho Viking II', char_15_passive: 'Passiva: Fúria (Dano/Vel qnd HP baixo)', char_15_active: 'Ativa (Q): Grito de Guerra',
            char_16_name: 'Coelho Ciborgue', char_16_passive: 'Passiva: Aura de EMP constante', char_16_active: 'Ativa (Q): Esfera de Choque em Área',
            char_17_name: 'Coelho Zen', char_17_passive: 'Passiva: Resistência a Dano fixa', char_17_active: 'Ativa (Q): Meditação (Cura 2 HP)',
            char_18_name: 'Coelho Mineiro', char_18_passive: 'Passiva: Ouro extra em baús', char_18_active: 'Ativa (Q): Dinamite de Proximidade',
            char_19_name: 'Coelho Radiante', char_19_passive: 'Passiva: Brilho na escuridão', char_19_active: 'Ativa (Q): Explosão Solar (AoE Stun)',
            char_20_name: 'Coelho Dimensional', char_20_passive: 'Passiva: Tiro Duplo Lâmina', char_20_active: 'Ativa (Q): Corte Dimensional (-50% HP Máx)',
            char_21_name: 'Coelho Colecionador', char_21_passive: 'Passiva: Tiro Ricochete (5x)', char_21_active: 'Ativa (Q): Bolha Coletora (Puxa inimigos)',
            char_22_name: 'Coelho Cósmico', char_22_passive: 'Passiva: Teclas [1] / [2] Trocam de Arma', char_22_active: 'Ativa (Q): Buraco Negro Temporal',
            char_23_name: 'Coelho Necromante', char_23_passive: 'Tiro: Magia Sombria (Explosão)', char_23_active: 'Ativa (Q): Necromancia (Invoca Boss)',
            char_24_name: 'Coelho Devorador', char_24_passive: 'Passiva: Hitkill a cada 10s', char_24_active: 'Ativa (Q): Teleporte Devorador (Rouba HP)',
        ...
        en: {
            ...
            leaderboard_hint: 'The greatest heroes who have dared the Burrow.',
            ...
            // — Characters —
            char_0_name: 'Stellar Rabbit', char_0_passive: 'Shot: Trail that pushes enemies', char_0_active: 'Active (Q): Magic Star Shower',
            char_1_name: 'Symbiote Rabbit', char_1_passive: 'Shot: Increased damage', char_1_active: 'Active (Q): Overload (3x Dmg & Invuln)',
            char_2_name: 'Thermal Rabbit', char_2_passive: 'Shot: Rapid fire burst', char_2_active: 'Active (Q): Piercing Plasma Laser',
            char_3_name: 'Chronos Rabbit', char_3_passive: 'Shot: Slows down enemies', char_3_active: 'Active (Q): Rejuvenate (Heals 2 HP)',
            char_4_name: 'Spiritual Rabbit', char_4_passive: 'Shot: Ricochet (3x)', char_4_active: 'Active (Q): Guardian Spirit Summon',
            char_5_name: 'Alchemist Rabbit', char_5_passive: 'Shot: Slows down enemies', char_5_active: 'Active (Q): Abyssal Ice Rain',
            char_6_name: 'Druid Rabbit', char_6_passive: 'Shot: Persistent poison', char_6_active: 'Active (Q): Toxic Nature (AoE Dmg & Poison)',
            char_7_name: 'Astronaut Rabbit', char_7_passive: 'Shot: Electric (Paralysis)', char_7_active: 'Active (Q): EMP Pulse (AoE Stun)',
            char_8_name: 'Pirate Rabbit', char_8_passive: 'Shot: Fire', char_8_active: 'Active (Q): Incendiary Barrage (5 Shots)',
            char_9_name: 'Viking Rabbit', char_9_passive: 'Shot: Fire', char_9_active: 'Active (Q): Lucky Clover (Gains Gold)',
            char_10_name: 'Ninja Rabbit', char_10_passive: 'Passive: Dodge Chance', char_10_active: 'Active (Q): Shadow Clone & Teleport',
            char_11_name: 'Alchemist II Rabbit', char_11_passive: 'Passive: Increased healing', char_11_active: 'Active (Q): Chemical Explosion',
            char_12_name: 'Druid II Rabbit', char_12_passive: 'Passive: Heals when entering rooms', char_12_active: 'Active (Q): Paralysis Roots',
            char_13_name: 'Astronaut II Rabbit', char_13_passive: 'Passive: Extended jump', char_13_active: 'Active (Q): Propulsion Jet',
            char_14_name: 'Pirate II Rabbit', char_14_passive: 'Passive: Bonus gold', char_14_active: 'Active (Q): Cannon Shower',
            char_15_name: 'Viking II Rabbit', char_15_passive: 'Passive: Rage (Dmg/Spd when low HP)', char_15_active: 'Active (Q): War Cry',
            char_16_name: 'Cyborg Rabbit', char_16_passive: 'Passive: Constant EMP Aura', char_16_active: 'Active (Q): Shock Sphere AoE',
            char_17_name: 'Zen Rabbit', char_17_passive: 'Passive: Fixed Damage Resistance', char_17_active: 'Active (Q): Meditation (Heals 2 HP)',
            char_18_name: 'Miner Rabbit', char_18_passive: 'Passive: Extra gold in chests', char_18_active: 'Active (Q): Proximity Dynamite',
            char_19_name: 'Radiant Rabbit', char_19_passive: 'Passive: Glows in darkness', char_19_active: 'Active (Q): Solar Burst (AoE Stun)',
            char_20_name: 'Dimensional Rabbit', char_20_passive: 'Passive: Double Blade Shot', char_20_active: 'Active (Q): Dimensional Cut (-50% Max HP)',
            char_21_name: 'Collector Rabbit', char_21_passive: 'Passive: Ricochet Shot (5x)', char_21_active: 'Active (Q): Collector Bubble (Pull enemies)',
            char_22_name: 'Cosmic Rabbit', char_22_passive: 'Passive: Keys [1] / [2] Switch Weapons', char_22_active: 'Active (Q): Temporal Black Hole',
            char_23_name: 'Necromancer Rabbit', char_23_passive: 'Shot: Dark Magic (Explosion)', char_23_active: 'Active (Q): Necromancy (Summons Boss)',
            char_24_name: 'Devourer Rabbit', char_24_passive: 'Passive: Instant kill every 10s', char_24_active: 'Active (Q): Devourer Teleport (Steals HP)',
        ...
        es: {
            ...
            leaderboard_hint: 'Los héroes más grandes que han desafiado la Madriguera.',
            ...
            // — Personajes —
            char_0_name: 'Conejo Estelar', char_0_passive: 'Disparo: Rastro que aleja enemigos', char_0_active: 'Activa (Q): Lluvia de Estrellas Mágicas',
            char_1_name: 'Conejo Simbionte', char_1_passive: 'Disparo: Daño aumentado', char_1_active: 'Activa (Q): Sobrecarga (3x Daño e Invuln.)',
            char_2_name: 'Conejo Térmico', char_2_passive: 'Disparo: Ráfaga rápida de fuego', char_2_active: 'Activa (Q): Láser de Plasma Perfurante',
            char_3_name: 'Conejo Cronos', char_3_passive: 'Disparo: Ralentiza a los enemigos', char_3_active: 'Activa (Q): Rejuvenecer (Cura 2 HP)',
            char_4_name: 'Conejo Espiritual', char_4_passive: 'Disparo: Rebote (3x)', char_4_active: 'Activa (Q): Invocación de Espíritos Guardianes',
            char_5_name: 'Conejo Alquimista', char_5_passive: 'Disparo: Ralentiza a los enemigos', char_5_active: 'Activa (Q): Lluvia de Hielo Abisal',
            char_6_name: 'Conejo Druida', char_6_passive: 'Disparo: Veneno persistente', char_6_active: 'Activa (Q): Naturaleza Tóxica (Daño y Veneno en área)',
            char_7_name: 'Conejo Astronauta', char_7_passive: 'Disparo: Eléctrico (Parálisis)', char_7_active: 'Activa (Q): Pulso EMP (Stun en área)',
            char_8_name: 'Conejo Pirata', char_8_passive: 'Disparo: Fuego', char_8_active: 'Activa (Q): Bombardeo Incendiario (5 Tiros)',
            char_9_name: 'Conejo Vikingo', char_9_passive: 'Disparo: Fuego', char_9_active: 'Activa (Q): Trébol de la Suerte (Gana Oro)',
            char_10_name: 'Conejo Ninja', char_10_passive: 'Pasiva: Probabilidad de Esquiva', char_10_active: 'Activa (Q): Clon Sombrío y Teletransporte',
            char_11_name: 'Conejo Alquimista II', char_11_passive: 'Pasiva: Curación aumentada', char_11_active: 'Activa (Q): Explosão Química',
            char_12_name: 'Conejo Druida II', char_12_passive: 'Pasiva: Cura al cambiar de sala', char_12_active: 'Activa (Q): Raíces Paralizantes',
            char_13_name: 'Conejo Astronauta II', char_13_passive: 'Pasiva: Salto prolongado', char_13_active: 'Activa (Q): Jet de Propulsión',
            char_14_name: 'Conejo Pirata II', char_14_passive: 'Pasiva: Oro extra', char_14_active: 'Activa (Q): Lluvia de Cañones',
            char_15_name: 'Conejo Vikingo II', char_15_passive: 'Pasiva: Furia (Daño/Vel cuando HP bajo)', char_15_active: 'Activa (Q): Grito de Guerra',
            char_16_name: 'Conejo Ciborg', char_16_passive: 'Pasiva: Aura de EMP constante', char_16_active: 'Activa (Q): Esfera de Choque en Área',
            char_17_name: 'Conejo Zen', char_17_passive: 'Pasiva: Resistencia a Daño fija', char_17_active: 'Activa (Q): Meditación (Cura 2 HP)',
            char_18_name: 'Conejo Minero', char_18_passive: 'Pasiva: Oro extra en cofres', char_18_active: 'Activa (Q): Dinamita de Proximidade',
            char_19_name: 'Conejo Radiante', char_19_passive: 'Pasiva: Brilla en la oscuridad', char_19_active: 'Activa (Q): Explosión Solar (AoE Stun)',
            char_20_name: 'Conejo Dimensional', char_20_passive: 'Pasiva: Disparo Doble Lámína', char_20_active: 'Activa (Q): Corte Dimensional (-50% HP Máx)',
            char_21_name: 'Conejo Coleccionista', char_21_passive: 'Pasiva: Disparo Rebote (5x)', char_21_active: 'Activa (Q): Burbuja Colectora (Atrae enemigos)',
            char_22_name: 'Conejo Cósmico', char_22_passive: 'Pasiva: Teclas [1] / [2] Cambian de Arma', char_22_active: 'Activa (Q): Agujero Negro Temporal',
            char_23_name: 'Conejo Nigromante', char_23_passive: 'Disparo: Magia Sombría (Explosión)', char_23_active: 'Activa (Q): Nigromancia (Invoca Boss)',
            char_24_name: 'Conejo Devorador', char_24_passive: 'Pasiva: Hitkill cada 10s', char_24_active: 'Activa (Q): Teletransporte Devorador (Roba HP)',
        ...
        fr: {
            ...
            leaderboard_hint: 'Les plus grands héros qui ont défié le Terrier.',
            ...
            // — Personnages —
            char_0_name: 'Lapin Stellaire', char_0_passive: 'Tir : Traînée qui repousse les ennemis', char_0_active: 'Active (Q) : Pluie d\'Étoiles Magiques',
            char_1_name: 'Lapin Symbiote', char_1_passive: 'Tir : Dégâts augmentés', char_1_active: 'Active (Q) : Surcharge (3x Dégâts & Invuln)',
            char_2_name: 'Lapin Thermique', char_2_passive: 'Tir : Rafale de feu rapide', char_2_active: 'Active (Q) : Laser Plasma Perforant',
            char_3_name: 'Lapin Chronos', char_3_passive: 'Tir : Ralentit les ennemis', char_3_active: 'Active (Q) : Rajeunir (Soigne 2 PV)',
            char_4_name: 'Lapin Spirituel', char_4_passive: 'Tir : Ricochet (3x)', char_4_active: 'Active (Q) : Invocation d\'Esprits Gardiens',
            char_5_name: 'Lapin Alchimiste', char_5_passive: 'Tir : Ralentit les ennemis', char_5_active: 'Active (Q) : Pluie de Glace Abyssale',
            char_6_name: 'Lapin Druide', char_6_passive: 'Tir : Poison persistant', char_6_active: 'Active (Q) : Nature Toxique (Dégâts & Poison de zone)',
            char_7_name: 'Lapin Astronaute', char_7_passive: 'Tir : Électrique (Paralysie)', char_7_active: 'Active (Q) : Impulsion EMP (Stun de zone)',
            char_8_name: 'Lapin Pirate', char_8_passive: 'Tir : Feu', char_8_active: 'Active (Q) : Barrage Incendiaire (5 Tirs)',
            char_9_name: 'Lapin Viking', char_9_passive: 'Tir : Feu', char_9_active: 'Active (Q) : Trèfle de Chance (Gagne de l\'or)',
            char_10_name: 'Lapin Ninja', char_10_passive: 'Passive : Chance d\'esquive', char_10_active: 'Active (Q) : Clone d\'Ombre et Téléportation',
            char_11_name: 'Lapin Alchimiste II', char_11_passive: 'Passive : Soins augmentés', char_11_active: 'Active (Q) : Explosion Chimique',
            char_12_name: 'Lapin Druide II', char_12_passive: 'Passive : Soigne en changeant de salle', char_12_active: 'Active (Q) : Racines Paralysantes',
            char_13_name: 'Lapin Astronaute II', char_13_passive: 'Passive : Saut prolongé', char_13_active: 'Active (Q) : Jet de Propulsion',
            char_14_name: 'Lapin Pirate II', char_14_passive: 'Passive : Or bonus', char_14_active: 'Active (Q) : Pluie de Canons',
            char_15_name: 'Lapin Viking II', char_15_passive: 'Passive : Rage (Dégâts/Vit quand PV bas)', char_15_active: 'Active (Q) : Cri de Guerre',
            char_16_name: 'Lapin Cyborg', char_16_passive: 'Passive : Aura EMP constante', char_16_active: 'Active (Q) : Sphère de Choc de zone',
            char_17_name: 'Lapin Zen', char_17_passive: 'Passive : Résistance aux dégâts fixe', char_17_active: 'Active (Q) : Méditation (Soigne 2 PV)',
            char_18_name: 'Lapin Mineur', char_18_passive: 'Passive : Or extra dans les coffres', char_18_active: 'Active (Q) : Dynamite de Proximité',
            char_19_name: 'Lapin Radiant', char_19_passive: 'Passive : Brille dans le noir', char_19_active: 'Active (Q) : Éruption Solaire (AoE Stun)',
            char_20_name: 'Lapin Dimensionnel', char_20_passive: 'Passive : Tir Double Lame', char_20_active: 'Active (Q) : Coupe Dimensionnelle (-50% PV Max)',
            char_21_name: 'Lapin Collectionneur', char_21_passive: 'Passive : Tir Ricochet (5x)', char_21_active: 'Active (Q) : Bulle Collectrice (Attire les ennemis)',
            char_22_name: 'Lapin Cosmique', char_22_passive: 'Passive : Touches [1] / [2] Changent d\'Arme', char_22_active: 'Active (Q) : Trou Noir Temporel',
            char_23_name: 'Lapin Nécromancien', char_23_passive: 'Tir : Magia Sombre (Explosion)', char_23_active: 'Active (Q) : Nécromancie (Invoque Boss)',
            char_24_name: 'Lapin Dévoreur', char_24_passive: 'Passive : Hitkill toutes les 10s', char_24_active: 'Active (Q) : Téléportation Dévoreuse (Vole PV)',
